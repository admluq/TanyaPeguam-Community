...
import { Save, User, MapPin, Globe, MessageCircle, Shield, Check, Upload, Camera } from 'lucide-react';
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-8">
          ...
          <div className="text-center mb-8">
            <div className="relative inline-block">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white font-bold text-2xl overflow-hidden">
              </div>
            ...
            <p className="text-gray-400 text-sm mt-2">Upload firm logo or profile photo</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-3 text-white placeholder:text-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                  placeholder="Founder / Principal Lawyer"
                />
              </div>
            </div>
